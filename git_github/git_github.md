...
2. Geração da Chave GPG com o gitbash:

   - Abra o gitbash
   - gpg --full-generate-key
   - gpg --list-secret-keys --keyid-format=long
   - Da lista de chaves GPG, copie a forma longa do ID da chave GPG que você gostaria de usar.
...
Com isso, seu ambiente está configurado para assinar e verificar commits usando GPG no Git e GitHub. Teste de GPG agent
